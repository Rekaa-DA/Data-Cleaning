...
* Inconsistent capitalization (manager / Manager / MANAGER)
* Invalid phone numbers (0, blank values)
* Improper email formats
...
* Standardized Department and Position names
* Validated phone numbers (10-digit check)
* Cleaned and standardized email formats
* Corrected address formatting
* Ensured proper data types (Date, Number, Text)
* Removed duplicates
